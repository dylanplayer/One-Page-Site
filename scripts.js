...
const infoSetup = () => {
  ...
  infoTextLead.innerHTML =
    "The Cavalli Penthouse set within the 38th floor of the coveted Century building is a bold design statement by the Jumbo Collection. With sprawling south facing views overlooking the Pacific Ocean.";
  ...
  infoTextLead3.innerHTML =
    "The interior boasts a flexible layout with a Gianfranco Ferre designed kitchen. The kitchen features a waterfall quartz island completed with Viking appliances.";
  ...
  infoTextLead4.innerHTML =
    "This newly-renovated penthouse showcases custom finishes and furnishings from Cavalli and Ferre included in the purchase.";
